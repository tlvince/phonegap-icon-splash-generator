...
$convert -resize 256x256 -extent 2048x1496 "$3/res/screen/ios/Default-Landscape@2x~ipad.png"
$convert -resize 256x256 -extent 1024x768 "$3/res/screen/ios/Default-Landscape~ipad.png"
$convert -resize 512x512 -extent 1536x2008 "$3/res/screen/ios/Default-Portrait@2x~ipad.png"
$convert -resize 1024x1024 -extent 768x1004 "$3/res/screen/ios/Default-Portrait~ipad.png"

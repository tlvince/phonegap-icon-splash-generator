...
convert -background none "$1" -resize 48x48 "$3/res/icon/android/icon-48-mdpi.png"
convert -background none "$1" -resize 96x96 "$3/res/icon/android/icon-96-xhdpi.png"
convert -background none "$1" -resize 128x128 "$3/res/icon/bada/icon-128.png"
convert -background none "$1" -resize 48x48 "$3/res/icon/bada-wac/icon-48-type5.png"
convert -background none "$1" -resize 80x80 "$3/res/icon/bada-wac/icon-80-type4.png"
convert -background none "$1" -resize 50x50 "$3/res/icon/bada-wac/icon-50-type3.png"
convert -background none "$1" -resize 80x80 "$3/res/icon/blackberry/icon-80.png"
convert -background none "$1" -resize 57x57 "$3/res/icon/ios/icon-57.png"
convert -background none "$1" -resize 72x72 "$3/res/icon/ios/icon-72.png"
convert -background none "$1" -resize 144x144 "$3/res/icon/ios/icon-72-2x.png"
convert -background none "$1" -resize 114x114 "$3/res/icon/ios/icon-57-2x.png"
convert -background none "$1" -resize 64x64 "$3/res/icon/webos/icon-64.png"
convert -background none "$1" -resize 48x48 "$3/res/icon/windows-phone/icon-48.png"
convert -background none "$1" -resize 173x173 "$3/res/icon/windows-phone/icon-173-tile.png"
convert -background none "$1" -resize 62x62 "$3/res/icon/windows-phone/icon-62-tile.png"

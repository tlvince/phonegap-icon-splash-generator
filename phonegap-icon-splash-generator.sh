...
usage() { echo "usage: $0 icon colour [dest_dir custom/project]"; exit 1; }
...
$convert -resize 1024x1024 -extent 1536x2008 	"$3/assets/res/splash/ios/Default-Portrait@2x.png"
$convert -resize 512x512 -extent 1024x748 		"$3/assets/res/splash/ios/Default-Landscape.png"
$convert -resize 1024x1024 -extent 2048x1496 	"$3/assets/res/splash/ios/Default-Landscape@2x.png"
$convert -resize 512x512 -extent 768x1024 		"$3/assets/res/splash/ios/Default-Portrait.png"
$convert -resize 1024x1024 -extent 1536x2048 	"$3/assets/res/splash/ios/Default-Portrait@2x.png"
$convert -resize 512x512 -extent 1024x768 		"$3/assets/res/splash/ios/Default-Landscape.png"
$convert -resize 1024x1024 -extent 2048x1536 	"$3/assets/res/splash/ios/Default-Landscape@2x.png"
